import {
  ...
  UPDATE_TRIXTA_ACTION, UPDATE_TRIXTA_ACTION_RESPONSE
} from './../constants/actions/index';
import { JOIN_TRIXTA_ROLE, REMOVE_TRIXTA_ROLE, UPDATE_TRIXTA_ERROR, UPDATE_TRIXTA_ROLE, UPDATE_TRIXTA_ROLES } from './../constants/index';
import {
  CLEAR_TRIXTA_REACTION_RESPONSE,
  SUBMIT_TRIXTA_REACTION_RESPONSE,
  SUBMIT_TRIXTA_REACTION_RESPONSE_FAILURE,
  SUBMIT_TRIXTA_REACTION_RESPONSE_SUCCESS, UPDATE_TRIXTA_REACTION, UPDATE_TRIXTA_REACTION_RESPONSE
} from './../constants/reactions/index';
import { defaultUnknownType, TrixtaActionDebugOptions, TrixtaActionDetails, TrixtaActionOptions, TrixtaActionResponseDetails, TrixtaReactionDetails, TrixtaReactionResponseDetails, TrixtaRoleParameter } from './../types';
...
export type SubmitTrixtaReactionResponseSuccessAction = {
  ...
  data: {roleName:string; reactionName:string; responseEvent?:string; errorEvent?:string;}|TrixtaReactionResponseDetails
}
...
data: {roleName:string; actionName:string; clearResponse?:boolean; responseEvent?:string; errorEvent?:string;}|TrixtaActionResponseDetails
}
