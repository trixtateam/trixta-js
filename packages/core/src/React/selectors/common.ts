...
/**
 * Selects all the disconnected roles
 */
export const selectDisconnectedTrixtaRoles = (state: {
  trixta: TrixtaState;
}): Array<TrixtaRoleParameter> => {
  return state.trixta.disconnectedRoles;
};

/**
 * Selects all the roles for the logged in agent as an array
 */
