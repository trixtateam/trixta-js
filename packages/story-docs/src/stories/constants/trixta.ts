...
export const DEFAULT_TRIXTA_ACTIONS = {
  ...
  [DEFAULT_TRIXTA_ROLES[1]]: [
    'everyone_authed_action',
    'everyone_authed_action2',
  ],
};
export const DEFAULT_TRIXTA_REACTIONS = {
  [DEFAULT_TRIXTA_ROLES[0]]: [
    'everyone_anon_reaction',
    'everyone_anon_reaction2',
  ],
  [DEFAULT_TRIXTA_ROLES[1]]: [
    'everyone_authed_reaction',
    'everyone_authed_reaction2',
  ],
};
